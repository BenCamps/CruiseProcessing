...
{
    public class VolumeLibraryMethodProvider_20241118
    {
        ...
        static extern void GETVOLEQ3(ref int region, StringBuilder forest, StringBuilder district, ref int spec, StringBuilder prod, StringBuilder voleq, out int err, int l1, int l2, int l3, int l4);
        [DllImport(DLL_NAME)]//, CallingConvention = CallingConvention.StdCall)]
        static extern void GETNVBEQ(ref int region, StringBuilder forest, StringBuilder district, ref int spec, StringBuilder voleq, out int err, int l1, int l2, int l4);
